...
该固定复验已于 2026-08-04 完成。预注册的四库 `c1p1` 至 `c4p4` 共 16 个新
outer units 全部获得正 Macro-AUPR 增量，总体平均增量为 `+0.105385`；四库
平均增量为 `+0.048809/+0.137953/+0.101750/+0.133030`。主要收益仍来自 CW，
WW 小幅提高，WC/CC 精确保留。全部新 outer Gate 均通过，且 outer 阶段没有
训练或参数选择。

因此 V3 不再标记为“B 级四库单 unit 候选证据”，而升级为**四库多支持单元
确认性证据**。论文允许主张其对 compound-cold/target-warm 支持失配具有跨库、
跨支持划分的稳定修复作用；禁止将该证据外推为 target-cold、double-cold 或
独立外部队列泛化。详细结果与哈希见
[重复 Outer 复验](FROZEN_BASE_HCTX_ROUTER_REPEATED_OUTER.md)。

历史 `c0p0` 加入描述性汇总后，四库均为 `5/5` 单元提高，20 单元总体
